    ...
    <section class="contianer">
        <a-row type="flex" justify="space-between">
            ...
            <div class="flights-content">
                ...
                <FlightsListHead />
                <!-- 航班信息 -->
                <FlightsItem v-for="(item,index) in jipiaoSon.flights.slice((page-1)*pageSize,page*pageSize)" :key="index" :data="item" :data1="index"  />
                <!-- 分页 -->
                <a-pagination :total="jipiaoSon.flights.lenght" show-size-changer show-quick-jumper :page-size-options="pageSizeOptions" v-model:current="current1" :page-size="pageSize" :show-total="total => `共 ${total} 条`">
