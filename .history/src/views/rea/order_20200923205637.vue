...
<div class="buy">
    <div class="buy_a">
        ...
        <div class="buy_b">
            ...
            <!-- 乘机人 -->
            <div class="biao_b">
                <a-form :model="item" class="biao_d pos-re" action v-for="(item,index) in arr" :key="index">
            ...
            <div class="submit">
                <a-form :model="form" ref="ruleForm" :rules="rules">
                    ...
                    <div class="d-flex">
                        ...
                        <a-button class="sendMsg" @click="countDown" :class="{disabled: !canClick}">{{content}}</a-button>
                    </div>
        ...
        <div class="buy_c" v-if="list.seat_infos">
            ...
            <div class="buy_k">
                <span>应付总额：</span>
                <span class="buy_l" v-if="checked1 === true && checked2 === true">￥{{(obj.settle_price_coupon+110)*arr.length}}.00</span>
                <span class="buy_l" v-else-if="checked1 === false && checked2 === false">￥{{(obj.settle_price_coupon+50)*arr.length}}.00</span>
