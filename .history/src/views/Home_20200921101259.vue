    ...
    <div class="banner-content">
        <div class="search-bar">
            ...
            <a-row type="flex" class="search-tab">
                <span v-for="(item,index) in options" :key="index" :class="{active: index===current}" @click="handleOption(index)">
                    <i>{{item.name}}</i>
                </span>
            </a-row>
            <!-- 输入框 -->
            <a-row type="flex" align="middle" class="search-input">
                <input type="text" :placeholder="options[current].placeholder" v-model="searchValue " @keyup.enter="handleSearch" />
