    ...
    <a-row type="flex" justify="center" align="middle" class="main">
      <div class="form-wrapper">
        ...
        <div v-if="current == 1" @zhuce="current=0">
          ...
          >
            <!-- 手机号码/用户名 输入框 -->
            <a-form-item class="form-item" ref="tells" name="tells">
              <a-input placeholder="用户名/手机" v-model="form.username"></a-input>
            </a-form-item>

            <!-- 手机验证码 输入框 -->
            <a-form-item class="form-item" prop="captcha">
              <a-input placeholder="验证码" v-model="form.captcha">
                <template slot="append">
                  <a-button :disabled="ison" @click="handleSendCaptcha">{{btninfo}}</a-button>
                </template>
              </a-input>
            </a-form-item>

            <!-- 昵称 输入框 -->
            <a-form-item class="form-item" prop="nickname">
              <a-input placeholder="你的名字" v-model="form.nickname"></a-input>
            </a-form-item>

            <!-- 密码 输入框 -->
            <a-form-item class="form-item" prop="password">
              <a-input placeholder="密码" type="password" v-model="form.password"></a-input>
            </a-form-item>

            <!-- 确认密码 输入框 -->
            <a-form-item class="form-item" prop="conpassword">
              <a-input placeholder="确认密码" type="password" v-model="form.conpassword"></a-input>
            </a-form-item>

            <a-button class="submit" type="primary" @click="handleRegSubmit">注册</a-button>
          </a-form>
        </div>
      </div>
    </a-row>
