  ...
  <div class="detailBox">
    <a-row type="flex" justify="space-between">
      ...
      <div class="detailLeft">
        ...
        <h4>评论</h4>
         <!-- 回复@ -->
         <a-tag v-show="isshow" closable type="info" style="margin-bottom: 10px;" @close="handleClose">
         回复 @{{replyTxt}}
         </a-tag>
         <!-- 输入框 -->
         ...
         <div>
            ...
            <a-upload  ref="upload" action="C:\Users\ZZH\Desktop\sdsscvsasvsx" list-type="picture-card" :on-success="coverSuccess" name="files">
            <i><PlusOutlined /></i>
            </a-upload>
         </div>
         </a-row>
...
data.isshow = false
 ...
 // eslint-disable-next-line @typescript-eslint/no-explicit-any
 const coverSuccess= (response: any , file: any ,fileList: any): void=>{
