<template>
<a-row class="create" type="flex" justify="space-between">
    <!-- 左边表单栏 -->
...
<script>
import CaogaoCreate from 'C:\Users\ZZH\Desktop\xianyun-master\components\post\caogaoCreate.vue'
...
export default {
    ...
    methods: {
        ...
        baocunCaogao() {
            ...
            if (fen < 10) fen = '0' + fen
            const time = data.getFullYear() + '-' + yue + '-' + ri + ' ' + ' ' + shi + ':' + miao + ':' + fen
