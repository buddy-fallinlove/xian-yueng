<template>
  <div class="rightPost">
    ...
    <!-- 分页 -->
    <div class="fenye">
      <a-pagination :page-size="pageSize" :current-page="pageIndex" :page-sizes="[3, 6, 9, 12]"></a-pagination>
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup(props, ctx: SetupContext) {
    ...
    const postComputed = (): void => {
      ...
      // const end = data.pageIndex * data.pageSize;
      // return data.postList.slice(start, end);
    };
    return {
      ...toRefs(data),
      postComputed,
