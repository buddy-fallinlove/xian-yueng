...
<div>
    <!-- 分页 -->
    <a-pagination :total="data.flights.length" show-size-changer show-quick-jumper :page-size-options="pageSizeOptions" v-model:current="current1" :page-size="pageSize" :show-total="total => `共 ${total} 条`">
