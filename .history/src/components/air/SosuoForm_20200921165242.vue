...
<div class="search-form">
    ...
    <a-form v-show="currentTab===0" class="search-form-content" ref="form" label-width="80px">
        ...
        <a-form-item label="出发城市" style="display: flex;">
            <a-input type="text" placeholder="请搜索出发城市" size="large" class="el-autocomplete" v-model="value1" />
        </a-form-item>
        <!--到达城市-->
        <a-form-item label="到达城市" style="display: flex;">
            <a-input type="text" placeholder="请搜索到达城市" size="large" class="el-autocomplete" v-model="value2" />
        </a-form-item>
        <!--出发时间-->
        <a-form-item label="出发时间" style="display: flex;">
            <div>
                <a-input-group compact>
                    <a-date-picker type="date" placeholder="请选择日期" v-model="value3" class="el-autocomplete" size="large" @change="change" />
                </a-input-group>
            </div>
        </a-form-item>
        <!-- 搜索 -->
