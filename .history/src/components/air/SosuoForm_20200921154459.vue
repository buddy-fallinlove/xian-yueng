...
<div class="search-form">
    ...
    <a-form v-show="currentTab===0" class="search-form-content" ref="form" label-width="80px">
        <!--出发城市-->
        <a-row>
            <div style="font-size: 14px; text-indent: 2em; line-height: 30px;height: 30px;">出发城市</div>
            <a-input type="text" placeholder="请搜索出发城市" class="el-autocomplete" />
        </a-row>

        <a-row>
            <div style="font-size: 14px; text-indent: 2em; line-height: 30px;height: 30px;">到达城市</div>
            <a-input type="text" placeholder="请搜索到达城市" class="el-autocomplete" />
        </a-row>
    </a-form>
    <!-- 往返购票口 -->
