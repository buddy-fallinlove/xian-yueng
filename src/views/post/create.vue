<template>
<div class="d-f j-c-c" style="margin-top:20px">
    <div class="createBox flex jsb">
        <div class="createOne">
            ...
            <div class="xieBox">
                <div class="format">
                    <div class="d-f j-s-b" style="width:300px">
                        <BoldOutlined />
                        <ItalicOutlined />
                        <UnderlineOutlined />
            ...
            <div class="flex ac">
                ...
                <a-auto-complete v-model:value="value" :data-source="dataSource" style="width: 200px" placeholder="搜索游玩城市" @select="onSelect" @change="onChange" />
            </div>
            <div class="d-f a-c" style="margin:20px 0">
