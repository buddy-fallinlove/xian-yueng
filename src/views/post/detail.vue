    ...
    <a-row type="flex" justify="space-between">
        ...
        <div class="detailLeft">
            ...
            <div v-for="(item,index) in wenzhang" :key="index">
                ...
                <div class="comment">
                    ...
                    <h4>评论</h4>
                    <!-- 回复@ -->
                    <a-tag v-show="isshow" closable type="info" style="margin-bottom: 10px;" @close="handleClose">回复 @{{replyTxt}}</a-tag>
                    <!-- 输入框 -->
                    <div class="comment-input">
                        <a-textarea type="textarea" :rows="2" placeholder="说点什么吧.  .  ." v-model="value" resize="none" />
                    </div>
                    <!-- 上传 -->
                    <a-row type="flex" justify="space-between">
                        <div>
                            <!-- 图片上传 :headers="{Authorization:'Bearer '+this.$store.state.user.userInfo.token}" -->
                            <a-upload ref="upload" action="https://www.mocky.io/v2/5cc8019d300000980a055e76" list-type="picture-card" :on-success="coverSuccess" name="files">
                                <i>
                                    <PlusOutlined />
                                </i>
                            </a-upload>
                        ...
                        <div>
                            <!-- <a-button size="small" type="primary" @click="tijiao">提交</a-button> -->
                        </div>
                    </a-row>
        ...
        <div class="detailRight">
            ...
            <div class="listRight">
                <a href="#" class="item">
                    <a-row type="flex" justify="space-between">
                        <img src="https://i0.hdslb.com/bfs/manga-static/6914c20a71436bc176482d1e42e3e70ada982bca.jpg@193w_258h_1c_90q.webp" class="item-img" />
                        <div class="item-info">
                            <h3>一日一生 ！！！！</h3>
